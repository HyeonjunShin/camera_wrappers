...
class KinectCamera:
    ...
    def start(self):
        ...
        self.k4a._set_color_control(
            ColorControlCommand.EXPOSURE_TIME_ABSOLUTE, 8330, ColorControlMode.MANUAL
        )
        self.k4a._set_color_control(
            ColorControlCommand.WHITEBALANCE, 4500, ColorControlMode.MANUAL
        )
    ...
    def getExposure(self):
        return self.k4a._get_color_control(ColorControlCommand.EXPOSURE_TIME_ABSOLUTE)[
            0
        ]

    def setExposure(self, value):
        print(self.getExposure())
        return self.k4a._set_color_control(
            ColorControlCommand.EXPOSURE_TIME_ABSOLUTE, value, ColorControlMode.MANUAL
        )
    ...
    def setBrightness(self, value):
        ...
        return self.k4a._set_color_control(
            ColorControlCommand.BRIGHTNESS, value, ColorControlMode.MANUAL
        )
    ...
    def setContrast(self, value):
        ...
        return self.k4a._set_color_control(
            ColorControlCommand.CONTRAST, value, ColorControlMode.MANUAL
        )
    ...
    def setSaturation(self, value):
        ...
        return self.k4a._set_color_control(
            ColorControlCommand.SATURATION, value, ColorControlMode.MANUAL
        )
    ...
    def setWhiteBalance(self, value):
        ...
        return self.k4a._set_color_control(
            ColorControlCommand.WHITEBALANCE, value, ColorControlMode.MANUAL
        )
    ...
    def setSharpness(self, value):
        ...
        return self.k4a._set_color_control(
            ColorControlCommand.SHARPNESS, value, ColorControlMode.MANUAL
        )

    def getBlackLightCompensation(self):
        return self.k4a._get_color_control(ColorControlCommand.BACKLIGHT_COMPENSATION)[
            0
        ]
    ...
    def setBlackLightCompensation(self, value):
        ...
        return self.k4a._set_color_control(
            ColorControlCommand.BACKLIGHT_COMPENSATION, value, ColorControlMode.MANUAL
        )
    ...
    def setPowerLineFrequency(self, value):
        ...
        return self.k4a._set_color_control(
            ColorControlCommand.POWERLINE_FREQUENCY, value, ColorControlMode.MANUAL
        )
    ...
    def setGain(self, value):
        print(self.getGain())
        return self.k4a._set_color_control(
            ColorControlCommand.GAIN, value, ColorControlMode.MANUAL
        )
